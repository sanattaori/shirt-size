...
public class SuggestionsActivity extends AppCompatActivity {
    ...
    private String Neck_width;

    private String mPhotoFilePath;
    private TextView mUserSizeTextView;
    private TextView mChestSizeTextView;
    private TextView mWaistSizeTextView;
    private TextView mShoulderSizeTextView;
    private TextView mNeckWidthSizeTextView;
    ...
    private void initializeView(){
        ...
        Neck_width = getIntent().getStringExtra("Neck_width");
        ...
        mChestSizeTextView = findViewById(R.id.chest_tv);
        mWaistSizeTextView = findViewById(R.id.waist_tv);
        mShoulderSizeTextView = findViewById(R.id.shoulder_tv);
        mNeckWidthSizeTextView = findViewById(R.id.Neck_width_tv);

        mUserSizeTextView.setText("Your Shirt size is " + mTshirtSize);
        mChestSizeTextView.setText("Your Chest size is " + chest);
        mWaistSizeTextView.setText("Your Waist size is " + waist);
        mShoulderSizeTextView.setText("Your Shoulder size is " + shoulder);
        mNeckWidthSizeTextView.setText("Your Neck Width size is " + Neck_width);
